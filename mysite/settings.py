...
if environment.is_development():
    local_settings_filename = "development_settings.py"
elif environment.is_production():
    local_settings_filename = "production_settings.py"
else:
    raise RuntimeError("Unknown application environment: " + environment.ENVIRONMENT_NAME)
f = os.path.join(PROJECT_APP_PATH, local_settings_filename)
if os.path.exists(f):
    import sys
    import imp
